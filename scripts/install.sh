...
echo -e "\n$INFO Starting Reviactyl Panel Installation..."

run_cmd "cp -rf .env ../ptero.env.bak" "Backing up existing .env to ../ptero.env.bak"
run_cmd "rm -rf *" "Cleaning current directory..."
run_cmd "curl -Lo panel.tar.gz https://github.com/reviactyl/panel/releases/latest/download/panel.tar.gz" "Downloading latest panel release..."
...
draw_progress "$PROGRESS_NOW" "$PROGRESS_TOTAL"
echo -e "\n$SUCCESS Reviactyl Panel installation completed successfully!"
