...
echo -e "\n$INFO Starting Reviactyl Panel Upgrade..."

run_cmd "curl -Lo upgrade.zip https://github.com/reviactyl/panel/releases/latest/download/upgrade.zip" "Downloading latest panel release..."
run_cmd "unzip upgrade.zip" "Extracting upgrade.zip..."
...
draw_progress "$PROGRESS_NOW" "$PROGRESS_TOTAL"
echo -e "\n$SUCCESS Reviactyl Panel upgrade completed successfully!"